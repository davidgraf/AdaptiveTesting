package at.reisisoft.jku.ce.adaptivelearning.topic.bpmn;
...
public class BPMNDataStorage extends AnswerStorage {
	...
	public boolean equals(BPMNDataStorage obj, int id) {
		if (obj.errortype != null && this.errortype != null && this.errortype.name.equals(obj.errortype.name) && this.errorelement == id) {
			return true;
		} else {
			return false;
		}
